...
import br.com.caelum.correios.auth.ProxyAuthenticator;
...
public class TesteClienteCorreios {
	private static final String PROXY = "10.10.190.25";
	...
	String cepDestino = "11070001"; // Caelum RJ
	...
	public static void main(String[] args) {
		new TesteClienteCorreios().testaClente(true);
	}
	
	void testaClente(boolean useProxy) {
		...
		CResultado resultado = cliente.calcPrecoPrazo(semCodigoEmpresa, semSenhaEmpresa, codigoSedex, cepOrigemCaelumSP, cepDestino,
				peso3kg, formatoEncomendaCaixa, comprimento20cm, altura10cm, largura15cm, diametro10cm, 
		...
		System.out.printf("Frete para %s é de R$%s. %n", cepDestino, valorFrete);	
	}
}
